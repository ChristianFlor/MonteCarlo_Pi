...
public class ControladorMC implements Runnable, ServicioMC{
	...
	public void abastecer(int codMaquina, int idAlarma) {
		...
		if (codMaquina == this.codMaquina) {
			...
			// Envio a Servidor
			servicioComMQCafe.desactivarAlarma(codMaquina, idAlarma,
					new Date());
		}
	}
    ...
    public void eventos() {
		...
		frame.getBtnMantenimiento().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				servicioComMQCafe.alarmaMaquina(
		...
		frame.getBtnEnviarReporte().addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                //TODO: revisar envio de reporte
				servicioComMQCafe.reporteVentas(codMaquina, new Date(),
    ...
    public void cargarRecetaMaquinas() {
        ...
        recetas.setElements(new HashMap());

		String[] recetasServer = servicioMQProxy.update();
